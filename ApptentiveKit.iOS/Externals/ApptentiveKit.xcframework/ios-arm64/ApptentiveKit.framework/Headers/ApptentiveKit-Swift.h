...
/// This property must be set before calling <code>register(credentials:)</code>.
/// It defaults to <code>false</code> for backward compatibility.
@property (nonatomic) BOOL shouldUseSecureTokenStorage;
...
/// Apptentive cross-platform look and feel.
  UIThemeApptentive = 1,
  UIThemeCustomerOnly = 2,
  UIThemeCustomerBasedOnApptentive = 3,
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable fontName;)
+ (NSString * _Nullable)fontName SWIFT_WARN_UNUSED_RESULT;
+ (void)setFontName:(NSString * _Nullable)value;
@end
...
- (void)logOut;
@property (nonatomic, copy) void (^ _Nullable authenticationFailureCallback)(enum ApptentiveAuthenticationFailureReason, NSString * _Nullable);
...
@property (nonatomic) enum ApptentiveLogLevel logLevel SWIFT_DEPRECATED_MSG("Logging now uses iOS's Unified Logging features so logs are no longer filtered by the SDK.");
/// If set, redacts potentially-sensitive information such as user data and credentials from logging.
@property (nonatomic) BOOL shouldSanitizeLogMessages SWIFT_DEPRECATED_MSG("Logging now uses iOS's Unified Logging features so redaction of sensitive information is handled automatically.");
/// The server URL to use for API calls. Should only be used for testing.
@property (nonatomic, copy) NSURL * _Nullable overrideBaseURL;
/// The region to use when resolving the API server base URL.
...
SWIFT_PROTOCOL("_TtP13ApptentiveKit18ApptentiveDelegate_")
@protocol ApptentiveDelegate
/// Indicates that an API request failed due to invalid or expired credentials.
- (void)authenticationDidFailWith:(NSError * _Nonnull)error;
@end
...
SWIFT_CLASS("_TtC13ApptentiveKit17GlassDialogButton") SWIFT_AVAILABILITY(ios,introduced=26)
@interface GlassDialogButton : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIBarButtonItem * _Nonnull appentiveRefresh;)
+ (UIBarButtonItem * _Nonnull)appentiveRefresh SWIFT_WARN_UNUSED_RESULT;
+ (void)setAppentiveRefresh:(UIBarButtonItem * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveTint;)
+ (UIColor * _Nonnull)apptentiveTint SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveTint:(UIColor * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveSurveyTextInputBackground;)
+ (UIColor * _Nonnull)apptentiveSurveyTextInputBackground SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveSurveyTextInputBackground:(UIColor * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveOtherTextInputBorder;)
+ (UIColor * _Nonnull)apptentiveOtherTextInputBorder SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveOtherTextInputBorder:(UIColor * _Nonnull)value;
/// The background color for survey “other” choice text fields.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveOtherTextInputBackground;)
+ (UIColor * _Nonnull)apptentiveOtherTextInputBackground SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveOtherTextInputBackground:(UIColor * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveMessageCenterAttachmentDeleteButton SWIFT_DEPRECATED_MSG("This property has been renamed to 'apptentiveAttachmentRemoveButton'.");)
+ (UIColor * _Nonnull)apptentiveMessageCenterAttachmentDeleteButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveMessageCenterAttachmentDeleteButton:(UIColor * _Nonnull)newValue;
/// The color to use for the button that deletes the attachment from the draft message.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveAttachmentRemoveButton;)
+ (UIColor * _Nonnull)apptentiveAttachmentRemoveButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveAttachmentRemoveButton:(UIColor * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nullable apptentiveDialogBackground;)
+ (UIColor * _Nullable)apptentiveDialogBackground SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogBackground:(UIColor * _Nullable)value;
/// The text color used for the title of the Enjoyment Dialog (“Love Dialog”) or a Text Modal (“Prompt”).
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveDialogTitle;)
+ (UIColor * _Nonnull)apptentiveDialogTitle SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogTitle:(UIColor * _Nonnull)value;
/// The text color used for the message of a Text Modal (“Prompt”).
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveDialogMessage;)
+ (UIColor * _Nonnull)apptentiveDialogMessage SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogMessage:(UIColor * _Nonnull)value;
/// The text color used for the button labels in the Enjoyment Dialog (“Love Dialog”) and Text Modals (“Prompts”).
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveDialogButtonBackground;)
+ (UIColor * _Nonnull)apptentiveDialogButtonBackground SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogButtonBackground:(UIColor * _Nonnull)value;
/// The text color used for the button labels in the Enjoyment Dialog (“Love Dialog”) and Text Modals (“Prompts”).
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveDialogButtonLabel;)
+ (UIColor * _Nonnull)apptentiveDialogButtonLabel SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogButtonLabel:(UIColor * _Nonnull)value;
/// The color for button borders.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveButtonBorder;)
+ (UIColor * _Nonnull)apptentiveButtonBorder SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveButtonBorder:(UIColor * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIColor * _Nonnull apptentiveDialogSeparator;)
+ (UIColor * _Nonnull)apptentiveDialogSeparator SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogSeparator:(UIColor * _Nonnull)value;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIFont * _Nonnull apptentiveDialogTitle;)
+ (UIFont * _Nonnull)apptentiveDialogTitle SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogTitle:(UIFont * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIFont * _Nonnull apptentiveDialogText;)
+ (UIFont * _Nonnull)apptentiveDialogText SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogText:(UIFont * _Nonnull)value;
/// The font used for the message of a Text Modal (“Prompt”) that also has a title.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIFont * _Nonnull apptentiveDialogMessage;)
+ (UIFont * _Nonnull)apptentiveDialogMessage SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogMessage:(UIFont * _Nonnull)value;
/// The font used for the button labels in the Enjoyment Dialog (“Love Dialog”) and Text Modals (“Prompts”).
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIFont * _Nonnull apptentiveDialogButton;)
+ (UIFont * _Nonnull)apptentiveDialogButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogButton:(UIFont * _Nonnull)value;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) UIImage * _Nullable apptentiveDialogHeader;)
+ (UIImage * _Nullable)apptentiveDialogHeader SWIFT_WARN_UNUSED_RESULT;
+ (void)setApptentiveDialogHeader:(UIImage * _Nullable)value;
@end
